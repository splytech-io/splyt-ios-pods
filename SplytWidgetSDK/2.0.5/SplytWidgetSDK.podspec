Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '9.0'
  s.source = { :http => 'https://storage.googleapis.com/splytech-files-mobile/splytech-widget/releases/ios/2.0.5/SplytWidgetSDK.zip' }
  s.pod_target_xcconfig = { 'SWIFT_VERSION' => '4' }
  s.ios.frameworks = 'CoreLocation'
  s.ios.vendored_frameworks = 'SplytWidgetSDK.xcframework'
